window.Messenger = function () {
    ...
    function b(a, b) {
        this.targets = {}, this.name = a, this.listenFunc = [], c = b || c, "string" != typeof c && (c = c.toString()), this.msgTester = new RegExp("^" + c), this.initListen()
    }

    var c = "[PROJECT_NAME]", d = "postMessage" in window;
    return d ? a.prototype.send = function (a) {
        try {
            ...
            } else alert("对不起,当前浏览器不支持聊天,请更换浏览器")
        }
    ...
    var c, d = {}, e = window, f = e.document, g = "localStorage", h = "script";
    if (d.disabled = !1, d.version = "1.3.17", d.set = function (a, b) {
        ...
        var l = function (a) {
            return function () {
                ...
                b.unshift(c), i.appendChild(c), c.addBehavior("#default#userData"), c.load(g);
                var e = a.apply(d, b);
    ...
    return d.enabled = !d.disabled, a.store = d, d
}(this), function (a) {
    var b = location.protocol + "//", c = location.host;
    a.WSDKCons = {
        PROJECT_NAME: "WSDK",
    ...
    var e = new RegExp("(http[s]{0,1}|ftp)://[a-zA-Z0-9\\.\\-]+\\.([a-zA-Z]{2,4})(:\\d+)?(/[a-zA-Z0-9\\.\\-~!@#$%^&*+?:_/=<>]*)?", "gi"), f = "https://g.alicdn.com/aliww/h5-openim/0.0.1/faces/", g = {};
    c.Event = {
        on: function (a, b, d, e) {
            if ("function" == typeof b) {
                if (e) {
                    var f = a, h = b;
                    b = function () {
                        c.Event.off(f, b, d), h.apply(this, arguments)
                    }
                }
                return a = a.split(/\s+/), a.forEach(function (a) {
                    var c = g[a] || (g[a] = []);
                    c.push({callback: b, context: d || this})
                }), this
            }
        }, one: function (a, b, d) {
            ...
            return a || b ? (a = a.split(/\s+/), a.forEach(function (a) {
                var c = g[a];
                if (!c)return this;
                if (!b)return delete g[a], this;
                for (var d = 0, e = c.length; e > d; d++)if (b === c[d].callback) {
                    c.splice(d, 1);
                    break
                }
            }), this) : (g = {}, this)
        ...
        for (var b, c = a || {}, d = a ? 1 : 0, e = arguments.length; e > d; d++)for (b in arguments[d])if (arguments[d].hasOwnProperty(b)) {
            var f = arguments[d][b];
            "" !== f && null !== f && "undefined" != typeof f && (c[b] = f)
        }
        return c
    }, c.checkParam = function (a, b) {
        var c = "param lost:", d = !1;
        if (a ? b.forEach(function (b) {
                "undefined" == typeof a[b] && (c += b + ";", d = !0)
            }) : (c += "param", d = !0), d)throw new Error(c);
        return a.uid && (a.uid = a.uid.toLowerCase()), a.touid && (a.touid = a.touid.toLowerCase()), !0
    }, c.callbackHandler = function (a, b) {
        b && (b.success || b.error) && c.Event.one(a, function (a) {
            a && 1e3 === a.code ? b.success && b.success.call(null, a) : b.error && b.error.call(null, a)
        })
    }, c.getScript = function (b, c, d, e) {
        var f, g = document.createElement("script"), h = document.getElementsByTagName("head")[0], i = function () {
            f && clearTimeout(f), c && c()
        };
        a.addEventListener ? g.addEventListener("load", function () {
            i()
        }, !1) : g.onreadystatechange = function () {
            ("loaded" == this.readyState || "complete" == this.readyState) && (g.onreadystatechange = null, i())
        }, g.src = b, h.insertBefore(g, h.firstChild), f = setTimeout(function () {
            d && d()
        }, e || 3e3)
    ...
    c.jsonp = function (b, c, d, e) {
        var f = +new Date, g = document.createElement("script"), i = document.getElementsByTagName("head")[0], j = h + f, k = null;
        e && g.setAttribute("charset", e), g.type = "text/javascript", g.id = j, a[j] = function (b) {
            try {
                var d = document.getElementById(j);
                k && clearTimeout(k), d && d.parentNode.removeChild(d), delete a[j], c && c.call(null, b)
            } catch (e) {
            }
        }, b += (b.indexOf("?") > -1 ? "&" : "?") + "callback=" + j, i.insertBefore(g, i.firstChild), g.src = b, k = setTimeout(function () {
            d && d.call(null, {code: 1002, resultText: "TIMEOUT"})
        }, 4e3)
    }, c.param = function (a) {
        var b = "";
        if (a) {
        ...
        if (4 != b)if (c.isArray(e) && e.length) {
            ...
            e.forEach(function (a, d) {
                g = "", "P" === a[0] || 0 === a[1].indexOf("http://interface.im") || 0 === a[1].indexOf("https://interface.im") || 0 === a[1].indexOf("http://mobileim.im") || 0 === a[1].indexOf("https://mobileim.etao") ? (g = a[1], b = c.unparam(g.split("?")[1]).type || 1, g = /^https:/.test(g) ? g.replace("https://interface.im.taobao", "https://mobileim.etao") : g.replace("http://interface.im.taobao", "http://mobileim.etao"), b = parseInt(b)) : "T" === a[0] && (g = a[1]), e[d + 1] && "Z" === e[d + 1][0] && (h = e[d + 1][1]), g.trim() && f.unshift({
                    type: b,
                    msg: g,
                    extInfo: h
                })
            })
        } else f.push({type: b, msg: e}); else b = 66, f.push({type: b, msg: e});
        return f
    ...
    var i = 36e5, j = 24 * i, k = (new Date).getTimezoneOffset() / 60;
    c.dateFormatter = function (a) {
        var b, c, d, e, f, g, h = new Date(a), l = new Date, m = +h, n = +l - (+l - k * i) % j;
        return b = h.getFullYear(), c = this.numFormatter(h.getMonth() + 1), d = this.numFormatter(h.getDate()), e = this.numFormatter(h.getHours()), f = this.numFormatter(h.getMinutes()), g = this.numFormatter(h.getSeconds()), l.getFullYear() == b ? m >= n && n + j > m ? "今天 " + e + ":" + f + ":" + g : c + "-" + d + " " + e + ":" + f + ":" + g : b + "-" + c + "-" + d + " " + e + ":" + f + ":" + g
        ...
        var d = (a.method || "GET").toUpperCase(), e = Math.random();
        if ("object" == typeof a.data) {
            var f = "";
            for (var g in a.data)f += g + "=" + a.data[g] + "&";
            a.data = f.replace(/&$/, "")
        }
        "GET" == d ? (a.data ? b.open("GET", a.url + "?" + a.data, !0) : b.open("GET", a.url + "?t=" + e, !0), b.send()) : "POST" == d && (b.open("POST", a.url, !0), b.setRequestHeader("Content-type", "application/x-www-form-urlencoded"), b.send(a.data)), b.onreadystatechange = function () {
    ...
    function c(a, b, c) {
        var d = document.createElement("form"), e = "";
        d.action = m, d.method = "post", d.enctype = "multipart/form-data", d.name = c, d.target = b, d.style.display = "none", d.acceptCharset = "UTF-8";
        for (var f in a)e += '<input type="hidden" name="' + f + '" value="' + a[f] + '" />';
        return d.innerHTML = e, document.body.appendChild(d), d
    }
    ...
    function d(a) {
        ...
        return b.name = a, b.style.display = "none", document.body.appendChild(b), b
    }

    var e = a.WSDKUtil, f = a.WSDKCons, g = e.Event, h = f.UPLOAD_PAGE, i = f.MAX_IMAGE_SIZE, j = f.DEFAULT_UPLOAD_TIMEOUT, k = "WSDK_FORM", l = "WSDK_FRAME", m = f.UPLOAD_URL, n = f.UPLOAD_SUCCESS_PROXY, o = {
        wx_web_token: "",
        user_id: "",
        mimetype: "",
        base64ed_file_data: "",
    ...
    !a.WSDKPlgs && (a.WSDKPlgs = {}), b.prototype = {
        constructor: b,
        __IsTokenFetching: !1,
        __Token: "",
        init: function (a) {
            this.Base = a.Base, a.isDaily && (m = "http://interface.im.daily.taobao.net/api/file/uploadFile.json", n = "http://chat.im.daily.taobao.net/uploadproxy.htm", o.redirect_url = n), this.messengerSender = a.Base.messengerSender, this.Messenger = a.__Messenger, this.__events()
        },
        upload: function (a) {
            e.checkParam(a, ["base64Str", "ext", "success"]), !a.error && (a.error = function () {
            }), (!a.maxSize || a.maxSize > i) && (a.maxSize = i), !a.type && (a.type = 1), this.param = a, this.upBase64(a)
        },
        __events: function () {
            var a = this;
            g.on("GET_UPLOAD_TOKEN", function (b) {
                a.__IsTokenFetching = !1, 1e3 === b.code ? (a.__Token = b.data.token, a.onGetUpTokenSuccess(), setTimeout(function () {
                    a.__Token = ""
                }, parseInt(b.data.expire) / 3 * 2 * 1e3)) : a.onGetUpTokenError()
            }), g.on("UPLOAD_IMAGE", function (b) {
                a.timeout && clearTimeout(a.timeout), a.timoeut = null, 1e3 == b.code ? a.uploadSuccess(b) : a.uploadError(b)
            })
        },
        getUpToken: function () {
            this.__IsTokenFetching || (this.__IsTokenFetching = !0, this.__Token ? this.onGetUpTokenSuccess() : this.messengerSender.call(this.Base, {action: "GET_UPLOAD_TOKEN"}, !0))
        },
        upBase64: function () {
            var a = this.param.base64Str;
            return a = a.substring(a.indexOf(",") + 1), this.param.base64StrForUpload = a, a.length > this.param.maxSize ? this.param.error({
                code: -4,
                errorText: p[-4]
            }) : void this.getUpToken()
        },
        onGetUpTokenSuccess: function () {
            this.__IsTokenFetching = !1, o.wx_web_token = this.__Token, o.base64ed_file_data = this.param.base64StrForUpload, o.mimetype = this.param.ext, o.user_id = this.Base.LoginInfo.prefix + this.Base.LoginInfo.uid, o.type = this.param.type;
            var a = this, b = +new Date;
            this.form = c(o, l + b, k + b), this.frame = d(l + b), this.timeout = setTimeout(function () {
                a.param.error && a.param.error({code: -3, errorText: p[-3]}), a.__Token = "", a.clear()
            }, this.param.timeout || j), this.Messenger.addTarget(this.frame.contentWindow, h), this.form.submit()
        },
        uploadSuccess: function (a) {
            this.param.success && this.param.success({
                code: 1e3,
                resultCode: "SUCCESS",
                data: {url: a.data, base64Str: this.param.base64Str}
            }), this.clear()
        },
        uploadError: function (a) {
            ...
            }), this.__Token = "", this.clear()
        },
        clear: function () {
            this.form && this.form.parentNode.removeChild(this.form), this.frame && this.frame.parentNode.removeChild(this.frame), this.form = null, this.frame = null
        },
        onGetUpTokenError: function () {
            this.param.error && this.param.error({code: -8, errorText: p[-8]})
        }
    ...
    var c = a.WSDKUtil, d = a.WSDKCons, e = d.UPLOAD_ERRORS;
    !a.WSDKPlgs && (a.WSDKPlgs = {}), b.prototype = {
        constructor: b, init: function (a) {
            this.Uploader = a.Plugin.Uploader
        }, upload: function (a) {
            c.checkParam(a, ["success"]), !a.error && (a.error = function () {
            });
            var b = a.error;
            this.param = a, a.target ? this.upTarget(a) : a.base64Img && a.ext ? this.upBase64(a) : b({
                code: -1,
                errorText: e[-1]
            })
        }, upTarget: function () {
            var a = this.param, b = a.target.files, c = a.target.value;
            if (!c)return a.error({code: -2, errorText: e[-3]});
            if (!this.isSupport() || !b || !b[0])return a.error({code: -3, errorText: e[-3]});
            var d = b[0], f = d.size, g = c.split("."), h = g[g.length - 1];
            if (f > a.maxSize)return a.error({code: -4, errorText: e[-4]});
            var i = this;
            this.getImageWH(d, function (a) {
                var b = i.getImageBase64(a, h);
                i.param.base64Img = b, i.param.ext = h, i.upBase64()
            }, function () {
                a.error({code: -5, errorText: e[-5]})
            })
        }, upBase64: function () {
            var a = this, b = this.param.base64Img;
            return b.length > this.param.maxSize ? this.param.error({
                ...
                success: function (b) {
                    a.param.success && a.param.success({
                        code: 1e3,
                        resultCode: "SUCCESS",
                        data: {url: b.data.url, base64Str: b.data.base64Str}
                    })
                },
                error: function (b) {
            ...
            var f = this;
            try {
                var g = a.URL || a.webkitURL, h = g.createObjectURL(b), i = new Image;
                i.onload = function () {
                    c && c(this), i.onload = i.onerror = null
                }, i.onerror = function () {
                    d && d(), i.onload = i.onerror = null
                }, i.src = h
            } catch (j) {
                return f.param.error({code: -3, errorText: e[-3]})
            }
        }, getType: function (a) {
            return a = a.toLowerCase(), "png" == a ? "image/png" : "image/jpeg"
        }, getImageBase64: function (a, b) {
            var c = this, d = "";
            try {
                var f = document.createElement("canvas"), g = f.getContext("2d");
                f.width = a.width, f.height = a.height, g.drawImage(a, 0, 0, a.width, a.height), d = f.toDataURL(this.getType(b), 1)
            } catch (h) {
                c.param.error({code: -3, errorText: e[-3]})
            }
            return d
        }, isSupport: function () {
    ...
    function g(a, b, c) {
        ...
        return a.forEach(function (a) {
            f == d && (f = 0), 0 == f && (e[g++] = []), d > f && (f++, e[g - 1].push(a))
        }), e
    }

    var h = a.WSDKUtil, i = ["加油", "色情狂", "委屈", "悲泣", "飞机", "生病", "不会吧", "痛哭", "怀疑", "花痴", "偷笑", "握手", "玫瑰", "享受", "对不起", "感冒", "凄凉", "困了", "尴尬", "生气", "残花", "电话", "害羞", "流口水", "皱眉", "鼓掌", "迷惑", "忧伤", "时钟", "大笑", "邪恶", "单挑", "大哭", "隐形人", "CS", "I服了U", "欠扁", "炸弹", "惊声尖叫", "微笑", "钱", "购物", "好累", "嘘", "成交", "红唇", "招财猫", "抱抱", "好主意", "很晚了", "收邮件", "举杯庆祝", "疑问", "惊讶", "露齿笑", "天使", "呼叫", "闭嘴", "小样", "跳舞", "无奈", "查找", "大怒", "算帐", "爱慕", "再见", "恭喜发财", "强", "胜利", "财迷", "思考", "晕", "流汗", "爱心", "摇头", "背", "没钱了", "惊愕", "小二", "支付宝", "鄙视你", "吐舌头", "鬼脸", "财神", "等待", "傻笑", "学习雷锋", "心碎", "吐", "漂亮MM", "亲亲", "飞吻", "帅哥", "礼物", "无聊", "呆若木鸡", "再见", "老大", "安慰"], j = [{
        title: "加油",
        img: "10",
        code: "/:012"
        ...
        img: "53",
        code: "/:085"
    }, {title: "惊愕", img: "60", code: "/:O"}, {
        title: "安慰",
        img: "8",
        code: "/:086"
    }], k = "https://g.alicdn.com/aliww/h5-openim/0.0.1/faces/", l = "https://gw.alicdn.com/tps/TB1.eFIKXXXXXbUXFXXXXXXXXXX-320-675.jpg", m = "https://img.alicdn.com/tps/TB1O2CKHVXXXXbMXVXXXXXXXXXX.jpg", n = {
        trigger: !0,
        emots: i,
        emotsImg: l,
        emotSize: 45,
    ...
    !a.WSDKPlgs && (a.WSDKPlgs = {}), b.prototype = {
        ...
        render: function (b) {
            ...
            var c = h.extend({}, n, b), d = "", e = "", f = 0, i = c.row * c.col, j = c.row * c.emotSize, k = c.emotSize * c.col, l = c.emotsImg == m ? 2 : 0, o = document.createElement("div"), p = g(c.emots, c.col, c.row);
            if (p.forEach(function (a, b) {
                    emotWrapItemStyle = c.customStyle ? "" : 'style="display:' + (0 == b ? "block" : "none") + ";background:url(" + c.emotsImg + ") no-repeat 0 -" + b * (k - l) + "px;width:" + j + "px;height:" + k + "px;" + (l ? "background-size:100%;" : "") + '"', emotItemStyle = c.customStyle ? "" : 'style="display:block;float:left;cursor:pointer;width:' + c.emotSize + "px;height:" + c.emotSize + 'px;"', d += '<div class="wsdk-emot-wrap" ' + emotWrapItemStyle + ">", c.trigger && (e += '<i class="wsdk-emot-trigger-item' + (0 == b ? " wsdk-active" : "") + '" data-index="' + b + '"></i>'), a.forEach(function (a, c) {
                ...
                q.innerHTML = e, q.className = "wsdk-emot-trigger", c.container.appendChild(q);
                var r = q.getElementsByTagName("i")
            }
            var s = o.getElementsByTagName("div"), t = function (b) {
                b = b || a.event;
                ...
                if (c && "I" == c.tagName.toUpperCase()) {
                    ...
                    if (d == f)return;
                    s[f].style.display = "none", s[d].style.display = "block", r[f].className = "wsdk-emot-trigger-item", r[d].className = "wsdk-emot-trigger-item wsdk-active", f = d
                }
            };
        ...
        encode: function (a) {
            var b, e = "";
            return a = c(a), a.forEach(function (a) {
                e += d(a) && (b = f(a)) ? b : a
            }), e
        },
        ...
        decode: function () {
            ...
            }), a = a.substring(1), a = a.replace(/([\^?()\.\*\$])/g, "\\$1"), a = new RegExp("/:(" + a + ")", "g"), function (c) {
                return c && (c = c.replace(a, function (a) {
                    for (var c = !1, d = "", e = 0; b > e; e++)if (j[e].code == a) {
                        c = j[e].img, d = j[e].title;
                        break
                    }
                    return c && (a = "[" + d + "]"), a
                })), c = this.htmlDecode(c)
    ...
    function c(a, b, c, h) {
        ...
        delete b.timeout, delete b.frameObj;
        try {
        ...
        if (i.style.display = "none", i.name = "WSDK_FRAME", document.body.appendChild(i), l.__ProxyFrameLoadTimeOut = setTimeout(function () {
                l.__ProxyFrameLoadTimeOut = null, j.fire("LOGIN", {code: 1002, resultText: k[1002]})
        ...
        var q;
        return h && "POST" != h.toUpperCase() ? (a += "?" + g.param(b), i.src = a) : q = f(a, b), l.__ProxyForm = q, l
    }
    ...
    function e(a) {
        a = JSON.parse(a), j.fire(a.action, a.result), a.result && 1e3 == a.result.code && ("CHAT_START_RECEIVE_MSG" === a.action ? (j.fire("MSG_RECEIVED", a.result), 16908304 == a.result.data.cmdid && j.fire("CHAT.MSG_RECEIVED", a.result)) : "START_RECEIVE_ALL_MSG" === a.action && (j.fire("MSG_RECEIVED", a.result), 16908304 == a.result.data.cmdid ? j.fire("CHAT.MSG_RECEIVED", a.result) : 16908545 == a.result.data.cmdid && j.fire("TRIBE.MSG_RECEIVED", a.result)))
    }

    function f(a, b) {
        var c = document.createElement("form"), d = "";
        for (var e in b)d += '<input type="hidden" name="' + e + '" value="' + b[e] + '" />';
        return c.action = a, c.target = "WSDK_FRAME", c.method = "post", c.innerHTML = d, c.style.display = "none", document.body.appendChild(c), c.submit(), c
    }

    var g = a.WSDKUtil, h = a.WSDKCons, i = h.PROXY_ACTION_API, j = g.Event, k = h.CODE, l = h.DEFAULT_LOGIN_TIMEOUT, m = h.PROXY_PAGE, n = h.LOGIN_URL, o = h.PROXY_URL;
    !a.WSDKMods && (a.WSDKMods = {}), b.prototype = {
        constructor: b, init: function (a, b) {
            b && b.debug && "daily" === b.env && (n = "http://chat.im.daily.taobao.net:7001/login/oauth", o = "http://chat.im.daily.taobao.net:7001/proxy.htm", a.isDaily = !0), this.context = a, this.__events()
        }, __events: function () {
            var a = this;
            j.on("SET_LOGIN_INFO", function (b) {
            ...
            if (this.context && this.context.__Messenger && this.context.__Messenger.clear(), a.anonymous) {
                ...
                g.ajax({
                    url: i.getAnonymous,
                    method: "POST",
                    data: {appkey: a.appkey, deviceinfo: "{}"},
                    success: function (c) {
                        if (!c)return void(a.error && a.error({code: 1003, resultText: "获取匿名账号失败"}));
                        try {
                            if (c = JSON.parse(c), c.userid && c.password) {
                                ...
                                a.uid = c.userid.substring(8), a.credential = c.password, a.tokenFlag = 67, b._login(a)
                            } else a.error && a.error({code: 1003, resultText: "获取匿名账号失败"})
                        } catch (d) {
                            a.error && a.error({code: 1004, resultText: k[1004]})
                        }
                    },
                    error: function (b) {
                        console.log(b), a.error && a.error({code: 1005, resultText: k[1005]})
                    }
                })
            } else g.checkParam(a, ["uid", "appkey", "credential"]), this._login(a)
        }, _login: function (a) {
            g.checkParam(a, ["uid", "appkey", "credential"]);
            var b = this, d = a.uid, e = a.appkey, f = a.toAppkey || e, h = a.credential, i = void 0 === a.tokenFlag ? 64 : a.tokenFlag, m = a.timeout || l, o = a.error || function () {
                };
            if (a.error = function (a) {
                    b.__IsLogin = !1, clearTimeout(b.frameObj && b.frameObj.__ProxyFrameLoadTimeOut), o(a)
                }, g.callbackHandler("LOGIN", a), this.__IsLogin)return void j.fire("LOGIN", {
                code: 1008,
                resultText: k[1008]
            });
            this.LoginInfo = {uid: d, appkey: e, toAppkey: f, credential: h, tokenFlag: i};
            var p = {
                cross: !0,
                tokenFlag: i,
                uid: d,
            ...
            return a.success = function (a) {
                b.__IsLogin = !1, b.destroy(), c && c(a)
            }, g.callbackHandler("LOGOUT", a), this.messengerSender({action: "LOGOUT", result: {}}, !0), this
            ...
            return g.callbackHandler("GET_UNREAD_MSG_COUNT", a), this.messengerSender({
                action: "GET_UNREAD_MSG_COUNT",
                result: {count: a && a.count || 30}
            }, !0), this
        }, getRecentContact: function (a) {
            return g.callbackHandler("GET_RECENT_CONTACT_NEW", a), this.messengerSender({
            ...
            var a = this;
            return this.__IsStartListen || (this.__IsStartListen = !0, this.messengerSender({action: "START_RECEIVE_ALL_MSG"}, !0), j.one("STOP_RECEIVE_ALL_MSG", function () {
                a.__IsStartListen = !1
            })), this
        }, stopListenAllMsg: function () {
            return this.__IsStartListen && (this.__IsStartListen = !1, this.messengerSender({action: "STOP_RECEIVE_ALL_MSG"})), this
        }, getNick: function (a) {
            return a && a.length > 8 && (0 == a.indexOf(this.LoginInfo.prefix) || 0 == a.indexOf(this.LoginInfo.toPrefix)) ? a.substring(8) : a
        }, destroy: function () {
            d(this.frameObj), this.stopListenAllMsg(), j.fire("$destroy"), this.__IsLogin = !1
        }, getPrefixByAppkey: function (a) {
            return g.checkParam(a, ["appkey"]), g.jsonp(h.GET_APP_INFO_URL + "?appkey=" + a.appkey, function (b) {
                b.prefix ? a.success && a.success({code: 1e3, data: {prefix: b.prefix}}) : a.error && a.error({
                    code: 1003,
                    resultText: b.errmsg
                })
            }, function (b) {
            ...
            this.messengerSender({
                ...
                result: {appkey: this.LoginInfo.appkey, uid: this.LoginInfo.uid}
            })
        }
    }, a.WSDKMods.Base = b
}(this), function (a) {
    ...
    function c(b, c) {
        a.online && (d = a.online), a.online = [], e.getScript(i + "?" + e.param({
                uids: b,
            ...
            c.success && c.success({
                code: 1e3,
                resultText: h[1e3],
                data: {status: a.online}
            }), d && (a.online = d), d = null
        }, function () {
            c.error && c.error({code: 1005, resultText: h[1005]})
        })
    }

    var d, e = a.WSDKUtil, f = e.Event, g = a.WSDKCons, h = g.CODE, i = g.GET_USER_STATUS_URL;
    !a.WSDKMods && (a.WSDKMods = {}), b.prototype = {
        constructor: b, init: function (a) {
            this.Base = a.Base, this.messengerSender = a.Base.messengerSender, this.__events()
        }, __events: function () {
            var a = this;
            ...
            return e.checkParam(a, ["touid", "msg"]), e.callbackHandler("CHAT_SEND_MSG", a), this.messengerSender.call(this.Base, {
            ...
            return e.checkParam(a, ["touid", "msg"]), e.callbackHandler("CHAT_SEND_CUSTOM_MSG", a), this.messengerSender.call(this.Base, {
                action: "CHAT_SEND_CUSTOM_MSG",
                result: {touid: a.touid, msg: a.msg, msgId: a.msgId, summary: a.summary, hasPrefix: !!a.hasPrefix}
            }, !0), this
        }, sendMsgToCustomService: function (a) {
            return e.checkParam(a, ["touid", "msg"]), e.callbackHandler("CHAT_SEND_MSG_TO_CUSTOM_SERVICE", a), this.messengerSender.call(this.Base, {
            ...
            return e.checkParam(a, ["touid", "customData"]), "object" == typeof a.customData && (a.customData = JSON.stringify(a.customData)), e.callbackHandler("CHAT_SEND_CUSTOM_DATA", a), this.messengerSender.call(this.Base, {
            ...
            return e.checkParam(a, ["touid"]), e.callbackHandler("GET_HISTORY_MSG", a), this.messengerSender.call(this.Base, {
            ...
            return e.checkParam(a, ["touid"]), e.callbackHandler("CHAT_SET_READ_STATE", a), this.messengerSender.call(this.Base, {
                action: "CHAT_SET_READ_STATE",
                result: {touid: a.touid, timestamp: a.timestamp || parseInt(+new Date / 1e3), hasPrefix: !!a.hasPrefix}
            }, !0), this
            ...
            return this.__IsStartRecv || (this.__IsStartRecv = !0, this.messengerSender.call(this.Base, {
                ...
                result: {touid: a.touid, hasPrefix: !!a.hasPrefix}
            }, !0), f.one("CHAT_STOP_RECEIVE_MSG", function () {
                b.__IsStartRecv = !1
            })), this
        }, stopListenMsg: function () {
            return this.__IsStartRecv && (this.__IsStartRecv = !1, this.messengerSender({action: "CHAT_STOP_RECEIVE_MSG"})), this
        }, getRealChatId: function (a) {
            return e.checkParam(a, ["touid"]), e.callbackHandler("CHAT_GET_REAL_ID", a), this.messengerSender.call(this.Base, {
                action: "CHAT_GET_REAL_ID",
                result: {touid: a.touid, nocache: a.nocache, groupid: a.groupid, hasPrefix: !!a.hasPrefix}
            }, !0), this
            ...
            var b = "";
            if (a.hasPrefix)b = a.uids.join(";"), c(b, a); else {
                if (!a.appkey)throw new Error("需要appkey");
                this.Base.getPrefixByAppkey({
                    appkey: a.appkey, success: function (d) {
                        var e = d.data.prefix, f = [];
                        a.uids.forEach(function (a) {
                            f.push(e + a)
                        }), b = f.join(";"), c(b, a)
                    }, error: function () {
                        a.error && a.error({code: 1002, resultText: h[1002]})
                    }
                })
            }
            return this
    ...
    !a.WSDKMods && (a.WSDKMods = {}), b.prototype = {
        constructor: b, init: function (a) {
            this.Base = a.Base, this.messengerSender = a.Base.messengerSender
        }, sendMsg: function (a) {
            c.checkParam(a, ["tid", "msg"]), c.callbackHandler("TRIBE_SEND_MSG", a);
            var b = +new Date;
            ...
            return c.checkParam(a, ["tid"]), c.callbackHandler("TRIBE_GET_HISTORY_MSG", a), this.messengerSender.call(this.Base, {
                action: "TRIBE_GET_HISTORY_MSG",
                result: {tid: a.tid + "", count: a.count || 20, nextkey: a.nextkey || "", type: 2}
            }, !0), this
        }, getTribeInfo: function (a) {
            return c.checkParam(a, ["tid"]), c.callbackHandler("TRIBE_GET_INTO", a), this.messengerSender.call(this.Base, {
                action: "TRIBE_GET_INTO",
                result: {tid: parseInt(a.tid), excludeFlag: a.excludeFlag || 0}
            }, !0), this
        }, getTribeList: function (a) {
            return c.callbackHandler("TRIBE_GET_LIST", a), this.messengerSender.call(this.Base, {
                action: "TRIBE_GET_LIST",
                result: {tribeTypes: a.types || [0, 1, 2]}
            }, !0), this
        }, getTribeMembers: function (a) {
            return c.checkParam(a, ["tid"]), c.callbackHandler("TRIBE_GET_MEMBERS", a), this.messengerSender.call(this.Base, {
                action: "TRIBE_GET_MEMBERS",
                result: {tid: parseInt(a.tid)}
            }, !0), this
        }, responseInviteIntoTribe: function (a) {
            return c.checkParam(a, ["tid", "validatecode", "manager", "recommender"]), c.callbackHandler("TRIBE_RESPONSE_INVITE", a), this.messengerSender.call(this.Base, {
    ...
    var b = this.WSDKMods, c = this.WSDKCons, d = this.WSDKUtil, e = this.WSDKPlgs, f = c.PROJECT_NAME, g = c.CUSTOM_PAGE;
    return a.version = "2.1.5", a.prototype = {
        constructor: a, init: function (a) {
            return this.__Messenger = new Messenger(g, f), this.Event = d.Event, this.Base = new b.Base(this, a), this.Chat = new b.Chat(this), b.Tribe && (this.Tribe = new b.Tribe(this)), this.Plugin = {}, this.Plugin.Uploader = new e.Uploader(this), this.Plugin.Image = new e.ImgUp(this), this.Plugin.Emot = new e.Emot(this), this
        }, LoginInfo: {}
    }, a
});